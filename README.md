...
首先卸载旧版本
```
curl -fsSL https://gh-proxy.org/raw.githubusercontent.com/VoidInTheShell/glut_network-autologin/refs/heads/feature/uninstall.sh -o uninstall.sh && sh uninstall.sh
```
然后安装新版本
```
sh -c "$(curl -fsSLk https://gh-proxy.org/raw.githubusercontent.com/VoidInTheShell/glut_network-autologin/refs/heads/feature/install.sh)"
